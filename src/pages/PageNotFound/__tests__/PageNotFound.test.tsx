...
describe('PageNotFound', () => {
  ...
  it('renders the error message', () => {
    ...
    const errorMessage = screen.getByText("We're sorry, the page you requested could not be found.");
  ...
  it('renders the main container with correct class', () => {
    ...
    const container = screen.getByText('Page Not Found').closest('.not-found-container');
  ...
  it('renders all text content correctly', () => {
    ...
    expect(screen.getByText('Page Not Found')).toBeInTheDocument();
    expect(screen.getByText("We're sorry, the page you requested could not be found.")).toBeInTheDocument();
  ...
  it('renders multiple paragraph elements', () => {
    ...
    // Should have 2 paragraphs: one for error message, one for the link
  ...
  it('link is keyboard accessible', () => {
    ...
    // React Router Link components are inherently keyboard accessible
    expect(homeLink).toBeInTheDocument();
